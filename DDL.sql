...
LOCATION 's3://stedi-bucket-lakehouse/customer/landing/'
...
STORED AS INPUTFORMAT 'org.apache.hadoop.mapred.TextInputFormat' OUTPUTFORMAT 'org.apache.hadoop.hive.ql.io.HiveIgnoreKeyTextOutputFormat'
LOCATION 's3://stedi-bucket-lakehouse/customer/trusted/'
TBLPROPERTIES ('classification' = 'json');
...
STORED AS INPUTFORMAT 'org.apache.hadoop.mapred.TextInputFormat' OUTPUTFORMAT 'org.apache.hadoop.hive.ql.io.HiveIgnoreKeyTextOutputFormat'
LOCATION 's3://stedi-bucket-lakehouse/customer/curated/'
TBLPROPERTIES ('classification' = 'json');
...
LOCATION
  's3://stedi-bucket-lakehouse/accelerometer/landing'
TBLPROPERTIES (
  'classification'='json', 
...
STORED AS INPUTFORMAT 'org.apache.hadoop.mapred.TextInputFormat' OUTPUTFORMAT 'org.apache.hadoop.hive.ql.io.HiveIgnoreKeyTextOutputFormat'
LOCATION 's3://stedi-bucket-lakehouse/accelerometer/trusted/'
TBLPROPERTIES ('classification' = 'json');
...
STORED AS INPUTFORMAT 'org.apache.hadoop.mapred.TextInputFormat' OUTPUTFORMAT 'org.apache.hadoop.hive.ql.io.HiveIgnoreKeyTextOutputFormat'
LOCATION 's3://stedi-bucket-lakehouse/step-trainer/landing/'
TBLPROPERTIES ('classification' = 'json');
...
STORED AS INPUTFORMAT 'org.apache.hadoop.mapred.TextInputFormat' OUTPUTFORMAT 'org.apache.hadoop.hive.ql.io.HiveIgnoreKeyTextOutputFormat'
LOCATION 's3://stedi-bucket-lakehouse/step-trainer/trusted/'
TBLPROPERTIES ('classification' = 'json');
