...
AmazonS3_node1739211160063 = glueContext.create_dynamic_frame.from_options(format_options={"multiLine": "false"}, connection_type="s3", format="json", connection_options={"paths": ["s3://stedi-bucket-lakehouse/customer/trusted/"], "recurse": True}, transformation_ctx="AmazonS3_node1739211160063")

# Script generated for node Amazon S3
AmazonS3_node1739211128718 = glueContext.create_dynamic_frame.from_options(format_options={"multiLine": "false"}, connection_type="s3", format="json", connection_options={"paths": ["s3://stedi-bucket-lakehouse/accelerometer/landing/"], "recurse": True}, transformation_ctx="AmazonS3_node1739211128718")
