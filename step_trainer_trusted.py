...
AmazonS3_node1739263541930 = glueContext.create_dynamic_frame.from_options(format_options={"multiLine": "false"}, connection_type="s3", format="json", connection_options={"paths": ["s3://stedi-bucket-lakehouse/step-trainer/landing/"], "recurse": True}, transformation_ctx="AmazonS3_node1739263541930")

# Script generated for node Amazon S3
AmazonS3_node1739263658117 = glueContext.create_dynamic_frame.from_options(format_options={"multiLine": "false"}, connection_type="s3", format="json", connection_options={"paths": ["s3://stedi-bucket-lakehouse/customer/curated/"], "recurse": True}, transformation_ctx="AmazonS3_node1739263658117")
